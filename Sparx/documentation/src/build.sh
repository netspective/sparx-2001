...
NETCOMPONENTS_JAR=$JAVA_LIB/NetComponents-1.3.8/lib/NetComponents-1.3.8.jar
SOURCESTYLER_JAR=$JAVA_LIB/ant-source-styler/styler.jar
JAVACP=$JAVA_HOME/lib/tools.jar

USE_CLASS_PATH=$APP_CLASSES:$XERCES_JAR:$FRAMEWORK_JAR:$OROMATCHER_JAR:$LOG4J_JAR:$SERVLETAPI_JAR:$JDBC2X_JAR:$XALAN_JAR:$NETCOMPONENTS_JAR:$SOURCESTYLER_JAR:$JAVACP

java -Dant.home=$ANT_HOME -classpath $USE_CLASS_PATH:$ANT_HOME/lib/ant.jar:$ANT_HOME/lib/ant-optional.jar org.apache.tools.ant.Main -Dbasedir=$APP_ROOT -buildfile $BUILD_FILE $1 $2 $3 $4 $5
