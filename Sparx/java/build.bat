...
REM $Id: build.bat,v 1.7 2002-09-05 20:50:38 shahid.shah Exp $
...
if "%SPARX_REDIST_LIB%" == "" set SPARX_REDIST_LIB=%SPARX_HOME%\lib\redist
...
%JAVACMD% -classpath %SPARX_REDIST_LIB%\ant.jar;%SPARX_REDIST_LIB%\ant-optional.jar;%SPARX_REDIST_LIB%\xerces.jar;%JAVACP% org.apache.tools.ant.Main %1 %2 %3 %4 %5 %6 %7 %8 %9
