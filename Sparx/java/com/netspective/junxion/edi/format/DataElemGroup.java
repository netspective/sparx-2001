...
public interface DataElemGroup extends Serializable {

    public static final String ZEUS_XML_NAME = "data-elem-group";
    public static final String[] ZEUS_ATTRIBUTES = {"repeat-min", "delimiter", "name", "hide-element", "description", "repeat-max"};
