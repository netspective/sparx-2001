...
/**
 * $Id: GenerateStatementsIdentifiersClassTask.java,v 1.1 2002-09-28 04:19:56 shahid.shah Exp $
 */
...
public class GenerateStatementsIdentifiersClassTask extends Task
{
    static public final String DEFAULT_CLASS_NAME = "app.id.Statement";
    ...
    public GenerateStatementsIdentifiersClassTask()
    {
    }
    ...
    {
        log("Opening Statements (XML) file " + source + "...");
        StatementManager manager = StatementManagerFactory.getManager(source);
        try
        {
