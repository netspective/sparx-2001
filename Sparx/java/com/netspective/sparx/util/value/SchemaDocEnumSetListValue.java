...
/**
 * $Id: SchemaDocEnumSetListValue.java,v 1.1 2003-01-30 16:07:44 shahbaz.javeed Exp $
 */
...
public class SchemaDocEnumSetListValue extends ListSource
{
    ...
    public SelectChoicesList getSelectChoices(ValueContext vc)
    {
        ...
        SelectChoicesList list = schemaDoc.getEnumTableData(enumTableName);
        String[] caption = list.getCaptions();
        list.clear();

        for (int i = 0; i < caption.length; i ++)
        {
            list.add(new SelectChoice(caption[i]));
        }
