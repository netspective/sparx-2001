...
public class HtmlField extends TextField
{
    ...
    public HtmlField()
    {
        setSimpleName("html-" + fieldNumber);
        fieldNumber++;
    }

    public HtmlField(String aName, String aCaption)
    {
        super(aName == null ? "html-" + fieldNumber : aName, aCaption);
        fieldNumber++;
    }

    /**
     * Given an XML element, read the contents of the entire <field.html> body as pure XHTML.
     */
