...
/**
 * $Id: RecordUpdateComponentCommand.java,v 1.1 2003-01-20 05:33:06 roque.hernandez Exp $
 */
...
public class RecordUpdateComponentCommand extends StatementComponentCommand
{
    static public final String COMMAND_ID = "record-edit-update";

    static public final Documentation DOCUMENTATION = new Documentation(
                "Displays results of a SQL statement and a dialog to be executed along with it in update mode.",
    ...
    public void setCommand(StringTokenizer params)
    {
        ...
        if(params.hasMoreTokens())
            dialogCommand = ComponentCommandFactory.getDialogCommand(params.nextToken() + ",edit");
        else {
            dialogCommand = ComponentCommandFactory.getDialogCommand(statementName + ",edit");
        }
    }
}
