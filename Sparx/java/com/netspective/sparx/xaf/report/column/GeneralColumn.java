...
public class GeneralColumn implements ReportColumn
{
    ...
    private SingleValueSource headingAnchorAttrsValueSource;
    ...
    public SingleValueSource getHeadingAnchorAttrs()
    {
        return headingAnchorAttrsValueSource;
    }

    public void setHeadingAnchorAttrs(String value)
    {
        headingAnchorAttrsValueSource = (value != null && value.length() > 0) ? ValueSourceFactory.getSingleOrStaticValueSource(value) : null;
    }
    ...
    public void importFromColumn(ReportColumn rc)
    {
        ...
        this.headingAnchorAttrsValueSource = rc.getHeadingAnchorAttrs();
    ...
    public void importFromXml(Element elem)
    {
        ...
        value = elem.getAttribute("allow-sort");
        if(value.equals("yes"))
            setFlag(ReportColumn.COLFLAG_SORT_ALLOWED);
