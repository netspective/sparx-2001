...
/**
 * $Id: StatementExecutionException.java,v 1.1 2002-01-20 14:53:17 snshah Exp $
 */
...
public class StatementExecutionException extends Exception
{
    ...
    public final String getStmtId()
    {
        return stmtInfo.getId();
    }

    public final StatementInfo getStmtInfo()
    {
        return stmtInfo;
    }

    public final StatementManager getManager()
    {
        return stmtManager;
    }
