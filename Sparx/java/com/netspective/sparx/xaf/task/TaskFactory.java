...
/**
 * $Id: TaskFactory.java,v 1.1 2002-01-20 14:53:19 snshah Exp $
 */
...
{
    static Map taskMap = new HashMap();

    static
    {
        addTask("exec-statement", com.netspective.sparx.xaf.task.sql.StatementTask.class);
        addTask("exec-dml", com.netspective.sparx.xaf.task.sql.DmlTask.class);
        addTask("exec-redirect", com.netspective.sparx.xaf.task.navigate.RedirectTask.class);
        addTask("exec-transaction", com.netspective.sparx.xaf.task.sql.TransactionTask.class);
    }
