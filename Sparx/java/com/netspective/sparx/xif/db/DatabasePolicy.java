...
/**
 * $Id: DatabasePolicy.java,v 1.6 2002-12-05 18:24:29 shahid.shah Exp $
 */
...
public interface DatabasePolicy
{
     ...
     *
     * @param conn The database connection to use
     * @param tableName The sequence name or the table name
     ...
     * to be used. This ID should be the same as the ID used for the DDL generator.
     */
