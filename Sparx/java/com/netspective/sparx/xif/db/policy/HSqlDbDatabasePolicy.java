...
/**
 * $Id: HSqlDbDatabasePolicy.java,v 1.3 2002-12-05 18:26:27 shahid.shah Exp $
 */
...
public class HSqlDbDatabasePolicy extends BasicDatabasePolicy
{
    ...
    {
        return executeAndGetSingleValue(conn, "CALL IDENTITY()");
    }
