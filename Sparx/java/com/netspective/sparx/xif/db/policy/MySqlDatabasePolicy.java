...
/**
 * $Id: MySqlDatabasePolicy.java,v 1.1 2002-12-05 18:25:55 shahid.shah Exp $
 */
...
public class MySqlDatabasePolicy extends BasicDatabasePolicy
{
    ...
    {
        return executeAndGetSingleValue(conn, "select last_insert_id()");
    }
