...
public class _admingiftdetail__jsp extends com.caucho.jsp.JavaPage{
    ...
    throws javax.servlet.ServletException
  {
    ...
    _caucho_line_map = new com.caucho.java.LineMap("_admingiftdetail__jsp.java", "/babyreg/AdminGiftDetail.jsp");
    _caucho_line_map.add(1, 1);
    _caucho_line_map.add(1, 27);
    _caucho_line_map.add(4, 29);
    _caucho_line_map.add(4, 39);
    _caucho_line_map.add(8, 40);
    _caucho_line_map.add(8, 48);
    com.caucho.vfs.Depend depend;
    depend = new com.caucho.vfs.Depend(appDir.lookup("AdminGiftDetail.jsp"), 1026789611828L, 311L);
