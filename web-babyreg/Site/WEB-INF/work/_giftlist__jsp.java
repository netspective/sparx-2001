...
public class _giftlist__jsp extends com.caucho.jsp.JavaPage{
    ...
    throws javax.servlet.ServletException
  {
    ...
    _caucho_line_map = new com.caucho.java.LineMap("_giftlist__jsp.java", "/babyreg/giftList.jsp");
    _caucho_line_map.add(1, 1);
    _caucho_line_map.add(1, 27);
    _caucho_line_map.add(5, 29);
    _caucho_line_map.add(5, 39);
    _caucho_line_map.add(10, 40);
    _caucho_line_map.add(10, 49);
    com.caucho.vfs.Depend depend;
    depend = new com.caucho.vfs.Depend(appDir.lookup("giftList.jsp"), 1025669397037L, 391L);
