...
set FRAMEWORK_ROOT=c:\projects\Framework
set APP_ROOT=c:\projects\web-cura
set APP_CLASSES=%APP_ROOT%\Site\WEB-INF\classes

set BUILD_FILE=%FRAMEWORK_ROOT%\tools\app-build.xml
...
set FRAMEWORK_JAR=%FRAMEWORK_ROOT%\tools\idea\classes
...
set USE_CLASS_PATH=%APP_CLASSES%;%XERCES_JAR%;%FRAMEWORK_JAR%;%OROMATCHER_JAR%;%LOG4J_JAR%;%SERVLETAPI_JAR%;%JDBC2X_JAR%;%XALAN_JAR%;%JAVACP%
